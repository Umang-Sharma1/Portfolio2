...
// ============================================================================
// ADMIN PANEL ICONS
// Centralized icon components for the admin dashboard
// ============================================================================
...
export function MessagesIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function CollapseIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
